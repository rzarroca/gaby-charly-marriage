...
export const CardSection = ({
  ...
  >
    ...
    <h2 className="mx-auto w-[95%] border-b-2 border-b-secondary py-[2svh] text-xl text-tertiary md:text-3xl">
      {title}
    </h2>
    {children}
    {footer && (
      <p className="mx-auto w-[95%] border-t-2 border-t-secondary px-6 py-[2svh] text-xl text-tertiary md:text-3xl">
        {footer}
      </p>
    )}
  </Component>
