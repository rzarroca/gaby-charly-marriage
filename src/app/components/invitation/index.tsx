...
export const Invitation = () => (
  <section
    className="h-dvh py-[10%] relative grid justify-items-center"
    aria-describedby="history"
  >
    <p
      id="history"
      className="flex flex-col font-curly text-5xl leading-snug px-[10%]"
    >
    ...
    <p className="justify-self-stretch text-start font-sans text-lg md:text-xl">
      ...
      <span className="px-[10%]">decidimos dar el SI</span>
    </p>
    <p className="text-3xl md:text-4xl font-curly leading-snug px-[10%]">
    ...
    <Image
      ...
      alt=""
      role="presentation"
      className="w-12 h-12 sm:w-20 sm:h-20 absolute bottom-[5%] left-[10%]"
    />
  </section>
);
